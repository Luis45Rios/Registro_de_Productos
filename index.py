...
titulo_nuevo_producto = Label(
    ventana, text="Nuevo producto", font="Arial, 35", bg="#454546", fg="#8ae0db")
titulo_nuevo_producto.place(x=725, y=30, anchor=CENTER)

# Labels and inputs
# PRODUCTO
lbl_nombre_producto = Label(
    ventana, text="Nombre del Producto: ", font="Arial, 15", bg="#454546", fg="#8ae0db")
lbl_nombre_producto.place(x=15, y=70)
entry_nombre_producto = Entry(ventana)
entry_nombre_producto.place(x=214, y=75)

# CANTIDAD
lbl_cantidad = Label(ventana, text="Cantidad: ",
                     font="Arial, 15", bg="#454546", fg="#8ae0db")
...
def añadir():
    ...
    if nombre_producto == "" or cantidad == "":
        ...
        print("Nombre del producto: ", entry_nombre_producto.get(),
              "Cantidad: ", entry_cantidad.get())

# Botones
# BOTON AÑADIR
btn_añadir = Button(ventana, text="Añadir Producto",
                    bg="#8ae0db", fg="#000", command=añadir)
